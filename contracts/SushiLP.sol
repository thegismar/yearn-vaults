...
contract StrategySushiswapPair is BaseStrategy {
    ...
    string public constant override name = "StrategySushiswapPairLP";
    ...
    function swap(
        ...
        Sushiswap(sushiswap).swapExactTokensForTokens(amount_in, 0, path, address(this), block.timestamp);
    }
